# ##     WORKING!!!               TEST 16. Drag & drop function: Create 2 lists with 'e' and without at the end of words
...
# ###############                                TEST 7. drag & drop function return dictionary key=symbols, values=count
