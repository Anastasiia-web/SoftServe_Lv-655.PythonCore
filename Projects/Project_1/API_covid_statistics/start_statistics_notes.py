...
try:
    if cs.country == "Ukraine":
        ...
        with open("Projects\Project_1\API_covid_statistics\src\statistics_Ukraine.txt", "a", encoding="utf-8") as ukr_st:
            ukr_st.write(permanent_notes)

    elif cs.country == "Poland":

        with open("Projects\Project_1\API_covid_statistics\src\statistics_Poland.txt", "a", encoding="utf-8") as pol_st:
            pol_st.write(permanent_notes)

    else:

        with open("Projects\Project_1\API_covid_statistics\src\statistics_others.txt", "a", encoding="utf-8") as oth_st:
